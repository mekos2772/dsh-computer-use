...
4. After each action, call get_app_state again to observe the new state before the next action. The screenshot self-verifies: an amber ring marks where the last action landed (confirm the effect), and a numbered crosshair grid lets you click({marker: 'D6'}) on visible targets instead of regressing raw pixels — prefer markers, use x/y only in unmarked areas.
